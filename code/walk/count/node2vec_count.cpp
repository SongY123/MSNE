...
#define FILE_LOG ".\\log1"
#define _DATA_BLOG_CATALOG_
#ifdef _DATA_ARXIV_
...
#endif // _DATA_ARXIV_
#ifdef _DATA_ARXIV_50_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 17902;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 17903; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_ARXIV_50_
...
#ifdef _DATA_BLOG_CATALOG_SHIFT_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 10311;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 10312; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_BLOG_CATALOG_SHIFT_
...
#ifdef _DATA_FACEBOOK_50_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 4038;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 4039; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_FACEBOOK_50_
#ifdef _DATA_WIKI_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 2404;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 2405; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_WIKI_
#ifdef _DATA_WIKI_SHIFT_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 4732;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 4733; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_WIKI_SHIFT_
#ifdef _DATA_PPI_
const unsigned MIN_IDX = 1;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 3890;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 3890; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_PPI_
#ifdef _DATA_PPI_SHIFT_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 3889;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 3890; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_PPI_SHIFT_
#ifdef _DATA_PPI_50_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 3851;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 3852; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_PPI_50_
...
#ifdef _DATA_DBLP_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 17724;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 17725; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_DBLP_
#ifdef _DATA_FLICKR_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 10261;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 10262; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_FLICKR_
#ifdef _DATA_FLICKR_TOTAL_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 80512;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 80513; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_FLICKR_TOTAL_
#ifdef _DATA_CORA_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 2707;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 2708; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_CORA_
#ifdef _DATA_WIKI_0424_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 2404;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 2405; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_WIKI_0424_
#ifdef _DATA_CITESEER_
const unsigned MIN_IDX = 0;  //const unsigned MIN_IDX = {min_idx};
const unsigned MAX_IDX = 3311;  //const unsigned MAX_IDX = {max_idx};
const unsigned N_NODES = 3312; //const unsigned N_NODES = {n_nodes};
#endif // _DATA_CITESEER_
...
static size_t UNI_INT(size_t beg, size_t end) {
...
int main()
{
    const string filename = "D:\\workspace\\vs\\cpp_playground\\cpp_playground\\data\\blogcatalog\\param\\1";
    ifstream in(filename);
    if (!in.good()) {
        cerr << "Probs will be initialized from " << filename << ", but it can't open." << endl;
        return 1;
    }
    string ln;
    vector<vector<Prob>> RES;
    while (in) {
        getline(in, ln);
        if (ln.size() != 0) {
            vector<Prob> probs = ln2prob(ln);
...
private:
    ...
    void init_dk_by_stepfile(const string& filename, const size_t& n_pre_dk) {
        ...
        for (IDX idx = MIN_IDX; idx <= MAX_IDX; ++idx) {
            ...
            PRELST[idx][dk] = true;
            lst2set(idx, dk);
            cnt_total += NSET[idx][dk].count();
        }
        time = clock() - time;
        _WR_DEBUG_(cout << "It took me " << time << " clicks (" << ((float) time) / CLOCKS_PER_SEC << ") seconds.\n";)
        _WR_DEBUG_(cout << "D1: " << cnt_total << "\n";)
        in.close();
    ...
    void init_table_d(const DK& dk_limit) {
        for (DK dk = 2; dk <= dk_limit; ++dk) {
            ...
            time = clock() - time;
            _WR_DEBUG_(cout << "It took me " << time << " clicks (" << ((float) time) / CLOCKS_PER_SEC << ") seconds.\n";)
            _WR_DEBUG_(cout << "D" << dk << ": " << cnt_total << "\n";)
        }
    }
...
void get_walks(ostream& out, const size_t& n_walk_round, Node2VecDist& dist, const string& file_out) {
    ...
    for (size_t round = 1; round <= n_walk_round; ++round) {
        _WR_DEBUG_(out << "Round " << round << "...\n";)
            clock_t round_time = clock();
        size_t cnt = 0;
        double mean_walk_time = 0;
        for (IDX idx = MIN_IDX; idx <= MAX_IDX; ++idx) {
            clock_t walk_time = clock();
            walks.push_back(dist.tabular_walk(idx));
            cnt += 1;
            //if (cnt % 100 == 0) {
            //    _WR_DEBUG_(out << '\r' << cnt << '/' << N_NODES;)
            //}
            walk_time = clock() - walk_time;
            mean_walk_time += walk_time;
        }
        round_time = clock() - round_time;
        mean_walk_time /= N_NODES;
        //_WR_DEBUG_(out << '\n';)
        _WR_DEBUG_(out << "[One Walk] It took me " << mean_walk_time << " clicks (" << ((float) mean_walk_time) / CLOCKS_PER_SEC << ") seconds.\n";)
            _WR_DEBUG_(out << "[One Round] It took me " << round_time << " clicks (" << ((float) round_time) / CLOCKS_PER_SEC << ") seconds.\n";)
    }
    total_time = clock() - total_time;
    _WR_DEBUG_(out << "[10 Walks] It took me " << total_time << " clicks (" << ((float) total_time) / CLOCKS_PER_SEC << ") seconds.\n";)
...
int main(int argc, char* argv[]) {
    ...
    cout << (ll << 32) << endl;
    if (argc < 3) {
        cerr << "prog-name file-para file-out [walk-round=10] [walk-steps=80]\\\n\t[file-in=`" << FILE_IN << "`] [n-pre-dk=" << N_PRE_DK << "] [file-log=" << FILE_LOG << "]\n" << endl;
        return 1;
    }
    ...
    // ARG: file-out
    // const string file_out = argv[2];
    // check_file_out(file_out);

    // ARG: walk-round
    size_t n_walk_round = 10;
    if (argc >= 4) {
        n_walk_round = stoul(argv[3], nullptr);
    }

    // ARG: walk-steps
    size_t walk_steps = 80;
    if (argc >= 5) {
        walk_steps = stoul(argv[4], nullptr);
    }
    ...
    if (argc >= 8) {
        ...
        for (size_t i = 0; i < mprs.size(); ++i) {
            _WR_DEBUG_(cout << "Setting mpr[" << i << "]...\n";)
                dist.set_mpr(mprs[i]);
            get_walks(log_out, n_walk_round, dist, file_outs[i]);
        }
    }
    else {
